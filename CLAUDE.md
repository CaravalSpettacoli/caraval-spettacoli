...
src/lib/
├── cn.ts, splitDisplay.tsx, theme-system.ts, calendario-utils.ts
...
- **`evento`** (riscritto Sess.5) — spettacolo ref, dataOra, luogo (object), modalitaAccesso enum (4), urlBiglietti condizionale, note, mostraInCalendario
